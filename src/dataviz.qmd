...
shp_barroco <- read_municipality(code_muni = "MG", showProgress = T, simplified = T)
...
# saveRDS(shp_br, here("data/shp_br.RDS"))
# saveRDS(shp_mg, here("data/shp_mg.RDS"))
# saveRDS(shp_mg_ri, here("data/shp_mg_ri.RDS"))
# 
# shp_br <- readRDS(here("data/shp_br.RDS"))
# shp_mg <- readRDS(here("data/shp_mg.RDS"))
# shp_mg_ri <- readRDS(here("data/shp_mg_ri.RDS"))
```
...
mapa_mg_2 <- ggdraw(mapa_mg) +
  draw_plot(mapa_br, x = 0.10, y = 0.575, width = 0.45, height = 0.394)
